...
const ::google::protobuf::ServiceDescriptor* WinNotice_descriptor_ = NULL;

}  // namespace


void protobuf_AssignDesc_win_5fnotice_2eproto() {
  protobuf_AddDesc_win_5fnotice_2eproto();
  ...
  HttpResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(HttpResponse));
  WinNotice_descriptor_ = file->service(0);
}
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_win_5fnotice_2eproto);
}
...
void protobuf_ShutdownFile_win_5fnotice_2eproto() {
...
void protobuf_AddDesc_win_5fnotice_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020win_notice.proto\022\006AdxRtb\"\r\n\013HttpReques"
    "t\"\016\n\014HttpResponse2@\n\tWinNotice\0223\n\006record"
    "\022\023.AdxRtb.HttpRequest\032\024.AdxRtb.HttpRespo"
    "nseB\003\200\001\001", 128);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "win_notice.proto", &protobuf_RegisterTypes);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_win_5fnotice_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_win_5fnotice_2eproto {
  StaticDescriptorInitializer_win_5fnotice_2eproto() {
    protobuf_AddDesc_win_5fnotice_2eproto();
  }
} static_descriptor_initializer_win_5fnotice_2eproto_;
...
const HttpRequest& HttpRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_win_5fnotice_2eproto();  return *default_instance_;
}
...
const ::google::protobuf::ServiceDescriptor* WinNotice::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return WinNotice_descriptor_;
}

const ::google::protobuf::ServiceDescriptor* WinNotice::GetDescriptor() {
  protobuf_AssignDescriptorsOnce();
  return WinNotice_descriptor_;
}

void WinNotice::record(::google::protobuf::RpcController* controller,
                         const ::AdxRtb::HttpRequest*,
                         ::AdxRtb::HttpResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method record() not implemented.");
  done->Run();
}

void WinNotice::CallMethod(const ::google::protobuf::MethodDescriptor* method,
                             ::google::protobuf::RpcController* controller,
                             const ::google::protobuf::Message* request,
                             ::google::protobuf::Message* response,
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), WinNotice_descriptor_);
  switch(method->index()) {
    case 0:
      record(controller,
...
const ::google::protobuf::Message& WinNotice::GetRequestPrototype(
...
const ::google::protobuf::Message& WinNotice::GetResponsePrototype(
    const ::google::protobuf::MethodDescriptor* method) const {
  GOOGLE_DCHECK_EQ(method->service(), descriptor());
  switch(method->index()) {
    case 0:
...
WinNotice_Stub::WinNotice_Stub(::google::protobuf::RpcChannel* channel)
  : channel_(channel), owns_channel_(false) {}
WinNotice_Stub::WinNotice_Stub(
...
void WinNotice_Stub::record(::google::protobuf::RpcController* controller,
